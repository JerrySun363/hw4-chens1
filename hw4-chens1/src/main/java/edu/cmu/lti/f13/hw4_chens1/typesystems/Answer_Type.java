 ...
 * @generated */
public class Answer_Type extends Document_Type {
  /** @generated */
  @Override
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("edu.cmu.lti.f13.hw4_chens1.typesystems.Answer");
  ...
  public double getScore(int addr) {
      ...
      jcas.throwFeatMissing("score", "edu.cmu.lti.f13.hw4_chens1.typesystems.Answer");
